...
@Component({
  template: `
    <nz-select [formControl]='control' [nzOptions]='props.options' [nzAllowClear]='props.allowClear'></nz-select>
  `
})
export class DropdownComponent implements FormControlTemplate<DropdownProps>, OnInit {
